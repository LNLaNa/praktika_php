...
/** @var PDO $db */
$db=require 'db.php';
$companies=$db->query("SELECT companies.id, companies.name,companies.logo, COUNT(jobs.company_id) 
    FROM companies LEFT JOIN jobs ON company_id = companies.id GROUP BY companies.id ORDER BY COUNT(jobs.company_id) DESC LIMIT 4")->fetchAll(PDO::FETCH_ASSOC);
$categories = $db->query("SELECT categories.id, categories.name, COUNT(jobs.category_id) 
    FROM categories LEFT JOIN jobs ON category_id = categories.id GROUP BY categories.id ORDER BY COUNT(jobs.category_id) DESC LIMIT 8")->fetchAll(PDO::FETCH_ASSOC);

$jobs=$db->query("SELECT natures.id, companies.logo, natures.name as natures_name, jobs.id,jobs.name,jobs.category_id, jobs.company_id,jobs.location,jobs.publication 
    FROM jobs INNER JOIN natures ON jobs.nature_id=natures.id
              INNER JOIN companies ON jobs.company_id=companies.id")->fetchAll(PDO::FETCH_ASSOC);
?>
<!doctype html>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section_title">
                        <h3 id="JobListing">Job Listing</h3>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    ...
                                    <div class="links_locat d-flex align-items-center">
                                        ...
                                        <div class="location">
                                            <p> <i class="fa fa-clock-o"></i> <?=$job['natures_name']?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
