...
$db=require 'db.php';
$id=$_GET['id'];
$jobs=$db->query("SELECT natures.id, natures.name as natures_name, companies.logo,jobs.id as id_job,
    jobs.name as name_job,jobs.category_id, jobs.company_id,jobs.location,jobs.publication,jobs.vacancy,jobs.salary 
    FROM jobs 
    INNER JOIN companies ON jobs.company_id=companies.id
    INNER JOIN natures ON jobs.nature_id=natures.id WHERE jobs.id={$id}
                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    <a href=""><h4><?=$jobs['name_job']?></h4></a>
                                    <div class="links_locat d-flex align-items-center">
                                        <div class="location">
                                            <p> <i class="fa fa-map-marker"></i> <?=$jobs['location']?></p>
                                        </div>
                                        <div class="location">
                                            <p> <i class="fa fa-clock-o"></i> <?=$jobs['natures_name']?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="apply_job_form white-bg">
                        ...
                        <form action="ln/send_form.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <input type="text" placeholder="Website/Portfolio link" name="link_p" id="link_p">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input_field">
                                        <textarea name="coverletter" cols="30" rows="10" placeholder="Coverletter" id="Coverletter"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="submit_btn">
                                        <input class="boxed-btn3 w-100" type="submit" value="Apply Now" id="Apply_Now">
                                    </div>
                                </div>
                            </div>
                        </form>
